...
OBJS = bin/bang_bang_controller.o bin/command_handler.o bin/daq.o bin/data_writer.o bin/main.o bin/queue.o bin/state_writer.o bin/telem_server.o bin/stat.o
